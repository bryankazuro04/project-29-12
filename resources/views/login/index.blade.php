...
<head>
	...
	<title>Login | Aratek</title>
</head>
<body>
	@if (session()->has('loginError'))
    <div class="alert alert-danger alert-dismissible fade show position-absolute right-0 mt-1 me-3" role="alert" data-bs-theme="dark">
      {{ session('loginError') }}
			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form action="/login" method="POST" class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "E-Mail is required">
						...
						<input class="input100" type="email" name="email" placeholder="Type your E-Mail" autocomplete="off">
					...
					<div class="flex-col-c">
						<span class="txt1 p-b-17 mt-2">Don't have account?</span>

						<a href="/register" class="txt2">Sign Up</a>
					</div>
				</form>
			</div>
		</div>
